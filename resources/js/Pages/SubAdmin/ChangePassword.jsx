...
export default function ChangePassword() {
    ...
    const handleSubmit = (e) => {
        ...
        router.post('/sub/change-password', formData, {
            onSuccess: () => {
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm text-yellow-800">
                                <strong>Forgot your password?</strong> If you can't remember your current password, 
                                please contact the Super Admin who can reset it for you.
                            </p>
                        </div>
                    </div>
                </div>
